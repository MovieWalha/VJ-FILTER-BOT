...
URL = "https://vj-filter-bot-1-jbh2.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-filter-bot-1-jbh2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-filter-bot-1-jbh2.onrender.com/".format(FQDN)
else:
    URL = "https://vj-filter-bot-1-jbh2.onrender.comm/".format(FQDN)
